...
//adapter class to hold only top three list view
public class SearchTopThreeAdapter extends ArrayAdapter < History > {

    Context mContext;
    int mResource;
    List < History > mTopThreeSearchList;

    public SearchTopThreeAdapter(Context context, int resource, List < History > objects) {
